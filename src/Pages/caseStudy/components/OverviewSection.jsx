        ...
        <div className='w-full text-white  bg-black py-14'>
            <div className='lg:w-[85%] mx-auto w-[90%] flex justify-between  flex-wrap'>
                <div className='lg:w-[50%] w-[90%]'>
                    <h1 className='lg:text-5xl font-semibold text-2xl'>Burger King, one of the world's largest fast-food restaurant chains.</h1>
                    <div className='w-full flex gap-x-4 mt-9 flex-wrap gap-y-4'>
                        <div className='w-full md:w-[45%] lg:w-[22%]'>
                            <h5 className='text-[1.3rem] font-semibold text-[#3970F0]'>Industry</h5>
                            <p className='text-base font-normal mt-3 text-[#CC5C2D]'>Marketing & Advertisement, Media</p>
                        </div>
                        <div className='w-full md:w-[45%] lg:w-[22%]'>
                            <h5 className='text-[1.3rem] font-semibold text-[#3970F0]'>Business Type</h5>
                            <p className='text-base font-normal mt-3'>Franchise</p>
                        </div>
                        <div className='w-full md:w-[45%] lg:w-[22%]'>
                            <h5 className='text-[1.3rem] font-semibold text-[#3970F0]'>Franchise</h5>
                            <p className='text-base font-normal mt-3 text-[#CC5C2D]'>Design, Development, and Deployment</p>
                        </div>
                        <div className='w-full md:w-[45%] lg:w-[22%]'>
                            <h5 className='text-[1.3rem] font-semibold text-[#3970F0]'>Build your idea</h5>
                            <p className='text-base font-normal mt-3'>Consult our experts</p>
                        </div>
                    </div>
                    <div className='mt-10 lg:mt-24'>
                        <h3 className='text-3xl my-4 font-semibold text-[#3970F0]'>Overview</h3>
                ...
                <div className='lg:w-[45%] w-[90%] mt-20 lg:mt-0'>
                    <img src={overviewImg} alt="" className='h-full' />
                </div>
            </div>
        </div>
    )
