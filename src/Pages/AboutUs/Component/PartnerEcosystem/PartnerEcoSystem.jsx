...
const PartnerEcoSystem = () => {
    ...
    return (
        <div className='w-screenmx-auto py-10'>
            <div className='w-[85%] mx-auto flex flex-wrap justify-start items-center'>
            <div className='w-[48%]  box-border flex flex-col justify-center gap-9'>
                <h1 className='text-[#3970F0] font-bold lg:text-3xl text-xl 2xl:text-[2.3rem] tracking-wide'>Our Partner Ecosystem</h1>
                <p className='w-[80%] text-gray-700 font-medium lg:text-lg text-sm 2xl:text-[1.2rem]'>Our collaborative ecosystem of market leaders brings together <span className='text-[#C66B00]'>  Conscientious Technology </span> world-class innovation and deep partner expertise to innovate for the future and drive value.</p>
            ...
            <div className='w-[50%]'>
                <div className="grid grid-cols-4 max-w-md mx-auto gap-x-[160px]  w-full">
                    {items.map((item, index) => {
                        ...
                        return (
                            <div
                                key={item}
                                className={`text-center flex items-center rounded-sm justify-center ${className} w-[160px] h-[80px]`}
