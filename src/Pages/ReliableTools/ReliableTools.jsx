                ...
                <tbody>
                    {categories.map((tools, i) => (
                        <tr key={tools._id}>
                            ...
                            <td className="border p-2"><button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => { navigate(`/conscientious-reliable-tools/${tools.faqCategory}`) }}>See All</button></td>
