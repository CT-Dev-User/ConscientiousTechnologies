...
const OtherReliableTools = () => {
    ...
    const fetchReliableData = async () => {
        try {
            ...
            setReliableToolsData(filteredData);
        } catch (error) {
            console.error(error);
        }
    };
    ...
    const addReliableDataFunc = async () => {
        try {
            ...
            if (response.status === 200) {
                ...
                setAddReliableData({ category:'',Subcategory: '', technology: '', subTech: [{ title: '', techLogos: [{ logo: null }] }] });
            }
        } catch (error) {
            console.error(error);
        }
    ...
    return (
        <div className='w-full bg-gray-300 h-full mx-auto p-4'>
            <div className="flex justify-end mb-5 mr-3 gap-x-3">
                ...
                <Button onClick={() => setAddPopUpShow(true)} className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-0 px-2 rounded'>Add Reliable Tools Data</Button>
            </div>
                ...
                <Modal.Body>
                    <form>
                        <div className="mb-3">
                         ...
                         <input type="text" className="form-control" id="category" name="category" value={addReliableData.category} onChange={(e) => handleInputChange(e)} />   
                        </div>
                        <div className="mb-3">
...
export default OtherReliableTools