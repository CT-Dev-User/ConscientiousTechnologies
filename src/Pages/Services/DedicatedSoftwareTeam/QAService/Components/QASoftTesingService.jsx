        ...
        },
        {
            ...
            desc: <div>
                ...
                <ul className='mt-2'>
                    ...
                    <li className='list-disc ms-5'>Executing tests and providing test reports.Providing tools and frameworks for automated testing.</li>
                </ul>
            </div>
        }
...
export default QASoftTesingService;
