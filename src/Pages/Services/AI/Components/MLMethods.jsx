...
const MLMethods = () => {
    ...
    return (
        ...
        <div className='lg:w-[85%] mx-auto w-full px-3 lg:px-0'>
            <h1 className='lg:text-3xl font-bold text-2xl lg:text-black text-[blue]'>Machine Learning Methods We Rely On</h1>
            <p className='lg:w-11/12 mt-2 w-full text-base'>Empowering Innovations: Leveraging state-of-the-art machine learning techniques, we at CT harness the power of data-driven insights to drive transformative solutions and unlock unprecedented opportunities for our clients.</p>
        </div>
