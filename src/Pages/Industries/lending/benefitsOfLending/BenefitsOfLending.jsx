...
const BenefitsOfLending = () => {
    ...
    return (
        <div id='how-we-work' className='w-[100vw] h-[auto] box-border py-[80px] md:py-[40px]'>
            ...
            <div className='hidden md:flex text-[white] w-[90%] flex-wrap mx-auto justify-center flex-wrap mt-[30px]'>
                {pythonDevData.map((data, i) => (
                    <div key={i} className={`w-[49%] h-[270px] text-[black] border-[#737373] border-dashed flex flex-col justify-around px-[5px] ${i === 0 || i === 2 || i === 4 ? 'border-r' : ''} ${i === 0 || i == 1 || i == 2 || i == 3 ? 'border-b' : ''}`} >
...
export default BenefitsOfLending