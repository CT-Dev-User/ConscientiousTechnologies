...
const OtherHeader = () => {
    ...
    const fetchHeadersByCategory = async () => {
        try {
            ...
            const filteredData = fetchData.filter(item =>
                ...
                item.headerCategory !== 'Services' &&
                item.headerCategory !== 'Industries' &&
                item.headerCategory !== 'Solutions'
            );
            setHeadersByCategory(filteredData);
    ...
    const addHeadersDataFunc = async () => {
        try {
            ...
            formData.append('headerCategory', addHeaders.headerCategory);
    ...
    const editHeadersFunc = async () => {
        try {
            const formData = new FormData();
            formData.append('headerCategory', editHeaders.headerCategory);
                ...
                <Modal.Body className="bg-white">
                    <form className="mx-auto max-w-lg">
                        <fieldset className="mb-4">
                            ...
                            <input type="text" className="form-control" id="Subcategory" name="Subcategory" value={addHeaders.headerCategory} onChange={(e) => setAddHeaders({ ...addHeaders, headerCategory: e.target.value })} />
                        </fieldset>
                        <fieldset className="mb-4">
                            <label htmlFor="title" className="block text-gray-700 font-bold">SubCategory</label>
                            <input type="text" className="form-control" id="Subcategory" name="Subcategory" value={addHeaders.headerSubCategory} onChange={(e) => setAddHeaders({ ...addHeaders, headerSubCategory: e.target.value })} />
                        </fieldset>
                        <fieldset className="mb-4">
            ...
            <Modal show={editPopupShow} onHide={() => setEditPopUpShow(false)}>
                ...
                <Modal.Body className="bg-white">
                    <form className="mx-auto max-w-lg">
                        <fieldset className="mb-4">
                            <label htmlFor="title" className="block text-gray-700 font-bold">SubCategory</label>
                            <input type="text" className="form-control" id="Subcategory" name="Subcategory" value={editHeaders.headerSubCategory} onChange={(e) => { seteditHeaders({ ...editHeaders, headerSubCategory: e.target.value }) }} />
                        </fieldset>
                        <fieldset className="mb-4">
                            <label htmlFor="title" className="block text-gray-700 font-bold">SubCategory</label>
                            <input type="text" className="form-control" id="Subcategory" name="Subcategory" value={editHeaders.headerSubCategory} onChange={(e) => { seteditHeaders({ ...editHeaders, headerSubCategory: e.target.value }) }} />
